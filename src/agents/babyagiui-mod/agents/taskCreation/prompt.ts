...
export const taskCreationPrompt = () => {
  const prompt = new PromptTemplate({
    inputVariables: ['objective', 'websearch_var', 'language'],
    template: `
    ...
    Create new tasks based on the objective. Limit tasks types to those that can be completed with the available tools listed below. Task description should be detailed. Task description must be answered in {language}.
